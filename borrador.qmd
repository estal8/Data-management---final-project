...
panel_recent_tbl <- panel_recent |>
  mutate(
    ...
    lpr_per_million = ifelse(imm_population > 0, 1e6 * lpr_total / imm_population, NA_real_),
...
summary_recent <- panel_recent_tbl |>
  ...
  mutate(
    variable = recode(variable,
      ...
      "alcohol_per_capita"          = "Beer consumption per capita (14+)"
    )
  )
