...
public_spending_clean <- public_spending |>
  ...
  filter(
    str_detect(AGG_DESC_LABEL, "Education - Total Expenditure") |
    str_detect(AGG_DESC_LABEL, "Public Welfare - Total Expenditure") |
    str_detect(AGG_DESC_LABEL, "Health - Total Expenditure") |
    str_detect(AGG_DESC_LABEL, "Correction - Total Expenditure") |
    str_detect(AGG_DESC_LABEL, "Police Protection - Total Expenditure")
  ) 
```

```{r}
# Clarifying the variables and sorting them by spending category
public_spending_clean |>
  mutate(
    State = NAME,
