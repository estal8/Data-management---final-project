...
where: Crime\_{it} denotes either violent or property crime in state i and year t, $\delta\_t$ are year fixed effects capturing nationwide shocks.
...
Crime\_{it} = \beta\_0 + \beta*1 Prison*{it} + \beta*2 PoliceShootings*{it} + \beta*3 PoliceSpending*{it} + \beta*4 CorrectionsSpending*{it} + \beta*5 Alcohol*{it} + \beta*6* \log(Pop{it}) + \delta*t +* \varepsilon{it}
