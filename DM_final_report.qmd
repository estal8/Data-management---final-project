...
modelsummary(
  list(
    "Model 1: Baseline" = model_property_1,
    "Model 2: Consumption" = model_property_2,
    "Model 3: Population" = model_property_3,
    "Model 4: Dynamic" = model_property_4,
    "Model 5: Two-ways fixed effects" = model_property_5
  ),
  vcov = robust_vcov,
...
modelsummary(
  list(
    "Model 1: Baseline" = model_violent_1,
    "Model 2: Consumption" = model_violent_2,
    "Model 3: Population" = model_violent_3,
    "Model 4: Dynamic" = model_violent_4,
    "Model 5: Two-ways fixed effects" = model_violent_5
  ),
  vcov = robust_vcov,
  stars = c('*' = 0.05, '**' = 0.01, '***' = 0.001),
  coef_rename = c(
...
For property crime, our variables explains approximately 76% of the within-state variation (R² = 0.76), which is consistent with economic theories on crime, suggesting for instance that property offences are motivated by financial need (Becker, 1968), that unemployment and alcohol consumption also increase crime rates (retrouver les articles lus là-dessus).

As for violent crime, our variables fails to significantly predict violent crime rates (R² = 0.31), indicating that violent offences are driven by factors beyond economic conditions alone.
