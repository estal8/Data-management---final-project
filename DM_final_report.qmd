...
Interestingly, unemployment rate is significantly and negatively correlated with violent crime in models 1-3 ($p < 0.001$). A 1 percentage point increase in unemployment rate leads to a decrease of around 9 violent crimes per 100 000 inhabitants for models 1-2 (representing about 2.4% of the average violent crime rate), and to a 2.8 decrease in model 3. This counterintuitive finding may reflect omitted variable bias, and should be interpreted with caution. The effect disappears in Model 4 after controlling for year fixed effects, suggesting it may capture only national time trends and not a structural relationship.
