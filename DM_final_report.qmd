...
Interestingly, unemployment rate is significantly and negatively correlated with violent crime in models 1-4 ($p < 0.001$). A 1 percentage point increase in unemployment rate leads to a decrease of around 9 violent crimes per 100 000 inhabitants for models 1-3, and to a 2,7 decrease in model 4. It is no longer significative in model 5. This counterintuitive finding may reflect omitted variable bias.
