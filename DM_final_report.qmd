...
We do not include GDP, consumption and population simultaneously because of the multicollinearity it clearly introduces. Instead, we will estimate alternative specifications to assess which measure is most strongly associated with crime (see following models). In fact, we choose not to include log population at all, as it is not directly linked to any of our hypothesis and as population changes slowly over time, the within-state variation in log population is limited and largely captured by the state fixed effects.
