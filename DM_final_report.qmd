...
Model 3 (Poverty) replaces $log(GDP)$ by $log(Pop)$ . Unemployment captures short-term labour market fluctuations, while poverty reflects persistent economic hardship. This specification tests which is strongly associated with crime.
...
modelsummary(
  list(
    ...
    "Model 3: Poverty" = model_property_3,
...
modelsummary(
  list(
    ...
    "Model 3: Poverty" = model_violent_3,
