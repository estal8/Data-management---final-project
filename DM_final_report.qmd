...
First we test for model that suits our data best.

```{r}
model_pooled <- plm(
  Data.Rates.Property.All ~ log_gdp_lag + share_pretax_income_p90p100 + 
    unemployment_lag + prison_lag + beer_lag + log(Data.Population),
  data = panel_reg,
  model = "pooling"
)
```
